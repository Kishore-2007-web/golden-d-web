      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-2">
              <img src={gzvLogoNew} alt="Golden Z Vision" className="h-12 w-auto object-contain" />
            </Link>
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              A micro-SaaS startup specializing in App & Web Development, Software Development,
              3D Simulation, and 3D Design.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/50 text-sm">
            © {currentYear} Golden Z Vision. All rights reserved.
          </p>
